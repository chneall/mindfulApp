...
const AddEmotionalHealth = ({navigation}) => {
    ...
    const handlePick2 = (emojiObject2) => {
      setFeeling2({
          ...feeling2,
          emoji2: emojiObject1.emoji2
      });
}

    const onSend = async () => {
        const docRef = await addDoc(collection(db, "EmotionalHealth"), feeling)
        navigation.goBack("Home");
    }

    const onSend1 = async () => {
      const docRef = await addDoc(collection(db, "EmotionalHealth1"), feeling1)
      navigation.goBack("Home");
  }

    const onSend2 = async () => {
      const docRef = await addDoc(collection(db, "EmotionalHealth2"), feeling2)
      navigation.goBack("Home");
  }
    ...
    return (
        ...
        <Text style={styles.heading2}>emotionally</Text>
        <View style={styles.headingWrapper}></View>
...
export default AddEmotionalHealth
