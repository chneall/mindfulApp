...
const AddPhysicalHealth = ({navigation}) => {
    ...
    const onSend = async () => {
        const docRef = await addDoc(collection(db, "PhysicalHealth"), feeling)
        navigation.goBack("Home");
    }

    const onSend1 = async () => {
      const docRef = await addDoc(collection(db, "PhysicalHealth1"), feeling1)
      navigation.goBack("Home");
  }

    const onSend2 = async () => {
      const docRef = await addDoc(collection(db, "PhysicalHealth2"), feeling2)
      navigation.goBack("Home");
  }
    ...
    return (
        ...
        <Text style={styles.heading2}>physically</Text>
        <View style={styles.headingWrapper}></View>
...
export default AddPhysicalHealth
