...
export default function EditEmotionalHealth({
    id,
    emoji,
    emoji1,
    emoji2,
    ...
    const onDelete = () => {
        const docRef = doc(db, 'EmotionalHealth', id);
        deleteDoc(docRef);
    }
    ...
    const onDelete1 = () => {
        const docRef = doc(db, 'EmotionalHealth1', id);
        deleteDoc(docRef);
    }
    ...
    const onDelete2 = () => {
        const docRef = doc(db, 'EmotionalHealth2', id);
        deleteDoc(docRef);
    }
