...
const AddSocialHealth = ({navigation}) => {
    ...
    const onSend = async () => {
        const docRef = await addDoc(collection(db, "SocialHealth"), feeling)
        navigation.goBack("Home");
    }

    const onSend1 = async () => {
      const docRef = await addDoc(collection(db, "SocialHealth1"), feeling1)
      navigation.goBack("Home");
  }

    const onSend2 = async () => {
      const docRef = await addDoc(collection(db, "SocialHealth2"), feeling2)
      navigation.goBack("Home");
  }
    ...
    return (
        ...
        <Text style={styles.heading2}>socially</Text>
        <View style={styles.headingWrapper}></View>
...
export default AddSocialHealth
